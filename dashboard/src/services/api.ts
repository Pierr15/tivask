...
export type Message={id:string;role:string;content:string;createdAt:string;delivery:string;replyToMessageId:string|null;whatsappMessageId:string|null;ticketId?:string};
