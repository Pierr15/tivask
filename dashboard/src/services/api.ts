...
export type Message={id:string;role:string;content:string;createdAt:string;delivery:string;route?:string|null;topic?:string|null;replyToMessageId?:string|null;whatsappMessageId?:string|null;ticketId?:string};
export type Ticket={id:string;whatsappNumber:string;question:string;summary:string;summarySource:string;reason:string;topic:string|null;status:string;priority:string;name:string|null;assignedTo:string|null;unreadCount:number;lastUserMessageAt:string|null;createdAt:string;updatedAt:string;resolvedAt:string|null};
